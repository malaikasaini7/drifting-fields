...
(function () {
  ...
  function makeField(canvas, opts) {
    ...
    function render(now) {
      ...
      // uniforms re-read every frame so playground controls stay live
  ...
  /* exposed for the playground - on the portfolio this auto-binds two
     fixed canvases (hero "dawn" + footer "dusk") instead */
